...
declare module 'react-native-ytdl' {
  ...
  function ytdl(link: string, options?: ytdl.downloadOptions): Promise<ytdl_url[]>;

  export = ytdl;
}

declare module 'react-native-ytpl' {
  namespace ytpl {
    interface Options {
   ...
   */
  function ytpl(id: string, options?: ytpl.Options, rt?: number): Promise<ytpl.Result>;
